          ...
          <div className="grid gap-6">
            <div>
              ...
              <p className="text-cyber-gray mb-4">
                Use these credentials to connect your device to the CYBERNET monitoring system.
              </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center bg-cyber-darker rounded-lg border border-cyber-cyan/20 p-1">
                    ...
                    <input
                      type="text"
                      value="udp://server.example.com:2055"
                      readOnly
                      className="flex-1 bg-transparent border-0 focus:ring-0 text-white px-3 py-2"
                    />
                    <button
                      onClick={() => {
                        navigator.clipboard.writeText("udp://server.example.com:2055")
